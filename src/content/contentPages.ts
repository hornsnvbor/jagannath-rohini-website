export const CONTENT_PAGES: Record<string, { title: string; content: string }> = {
  // ============================================
  // ABOUT DROPDOWN
  // ============================================

  'the-supreme-god': {
    title: 'The Supreme God – Lord Jagannath',
    content: `
Lord Jagannath, the Lord of the Universe, is the supreme deity worshipped at the Jagannath Mandir, Rohini. He is an incarnation of Lord Vishnu and is worshipped along with his elder brother Balabhadra and sister Subhadra.

## The Divine Trinity

- **Lord Jagannath** – The central deity, dark-complexioned with large round eyes
- **Lord Balabhadra** – The elder brother, fair-complexioned with a plough
- **Devi Subhadra** – The sister, yellow-complexioned with a gentle demeanor

The deities were originally installed in the ancient temple of Puri, Odisha. The Rohini temple follows the same rituals and traditions, bringing the sacred aura of Puri to the heart of Delhi.

Devotees believe that offering prayers at Jagannath Mandir brings peace, prosperity, and liberation from the cycle of birth and death. The temple is a spiritual haven for thousands of devotees who visit daily to seek the blessings of the divine trio.

## Significance

> *"Jai Jagannath" – The universal chant that unites all devotees*

The temple follows the **Chappan Bhog** tradition, offering 56 different food items to the Lord on special occasions. The deities are made of wood and are replaced every 12-19 years in a sacred ritual called 'Nabakalebara'.
`,
  },
...
The temple is built in the traditional **Odia style of architecture**, featuring a magnificent spire and intricate carvings. The main sanctum houses the deities of Lord Jagannath, Balabhadra, and Subhadra, along with other gods and goddesses.

## Spiritual & Cultural Hub

The temple is not just a place of worship but also a center for cultural and spiritual activities. It hosts:

- **Regular Bhajans & Kirtans** – Every evening
- **Spiritual Discourses** – Weekly sessions on scriptures
- **Festival Celebrations** – All major festivals with great fervor

The temple is open to all devotees regardless of caste, creed, or religion. The daily rituals follow the ancient traditions of the Puri Jagannath Temple, including the famous **Rath Yatra** which is celebrated annually with immense devotion.

## Temple Timings

| Day | Morning | Evening |
|-----|---------|---------|
| Monday – Sunday | 6:00 AM – 12:30 PM | 4:00 PM – 9:00 PM |
`,
  },
...
- From Gurugram: ~35 km via NH48.
- From Noida: ~30 km via DND Flyway.
...
`,
  ...
  'contact': {
    title: 'Contact Us',
    content: `
We would love to hear from you. For any queries, feedback, or seva bookings, please reach out to us.
...
You can also fill out the contact form on our website, and we will get back to you at the earliest.
`,
  },
...
`,
  ...
  'unique-saga': {
    title: 'Unique Saga of Bhagwan',
    content: `
The story of Lord Jagannath is deeply intertwined with the legends of Puri. The unique feature of the deities is that they are made of wood and are replaced every 12-19 years in a sacred ritual called **'Nabakalebara'**.

## The Wooden Deities

The Rohini temple follows the same tradition and is the only temple in Delhi to have wooden deities. The idols are carved from **Neem wood**, following the ancient scriptures.

> *"The deities are not just idols; they are living manifestations of the divine."*

## Nabakalebara – The Sacred Renewal

Nabakalebara is a rare and sacred ritual where the old deities are replaced with new ones. The new idols are carved from specially selected Neem trees and infused with divine energy through elaborate rituals.

## Chappan Bhog – 56 Offerings

The temple also follows the **Chappan Bhog** tradition, offering 56 different food items to the Lord on special occasions. The 'Rath Yatra' is celebrated with a grand procession of the deities on a magnificent chariot built by the temple community.

Every day, the temple conducts the **Dhoop Aarti** and **Sandhya Aarti**, which are attended by hundreds of devotees. The spiritual energy of the temple is palpable, making it a must-visit for seekers of divine grace.
`,
  },
...
`,
  ...
  'trustees': {
    title: 'EC Members / Trustees',
    content: `
The Jagannath Mandir Rohini is managed by a dedicated team of trustees and executive committee members who ensure the smooth functioning of the temple.

## Current Trustees (2024-26)

| # | Name | Position |
|---|------|----------|
| 1 | Shri Rajendra Kumar Mohanty | President |
| 2 | Shri Pradeep Kumar Das | Vice President |
| 3 | Shri Ashok Kumar Panda | Secretary |
| 4 | Smt. Sarojini Devi | Treasurer |
| 5 | Shri Bikram Keshari Rout | Joint Secretary |
| 6 | Shri Gagan Bihari Nayak | Member |

## Roles & Responsibilities

- **President** – Oversees all temple activities and represents the trust
- **Vice President** – Assists the President and handles administration
- **Secretary** – Manages day-to-day operations and correspondence
- **Treasurer** – Handles temple finances, donations, and accounts
- **Joint Secretary** – Coordinates events and seva bookings
- **Members** – Support various cultural and administrative activities

The trustees are elected by the general body of the Sangha and serve for a three-year term. Their dedication and hard work have been instrumental in the temple's growth and success.
`,
  },
  ...
  'festival-calendar': {
    ...
    content: `
The Jagannath Mandir Rohini celebrates all major Hindu festivals with great enthusiasm. Here is the tentative calendar for 2026.

## Major Festivals

| Festival | Date (2026) | Significance |
|----------|-------------|--------------|
| Makara Sankranti | 14 January | Special Puja, Mahaprasad |
| Vasant Panchami | 23 January | Saraswati Puja, Bhajan Sandhya |
| Maha Shivaratri | 13 February | Rudrabhishek, Jagran |
| Holi | 14 March | Holika Dahan, Colour Festival |
| Rama Navami | 8 April | Ram Katha, Bhajan |
| Pana Sankranti (Odia New Year) | 14 April | Special Puja, Mahaprasad |
| Akshaya Tritiya | 19 April | Rath Yatra Preparation |
| Buddha Purnima | 4 May | Special Puja, Meditation |
| **Rath Yatra** | **24 June** | **Grand Chariot Procession** |
| Jagannath Janma | 17 July | Special Puja, Festivities |
| Krishna Janmashtami | 25 August | Bhajan, Jhulan |
| Ganesh Chaturthi | 3 September | Ganesh Puja |
| Durga Puja | 1-5 October | Navratri, Durga Saptami |
| Kali Puja / Deepavali | 19 October | Kali Puja, Deepavali |
| Kartik Purnima | 15 November | Deep Dan, Kartik Snan |
| Prathamastami | 8 December | Elders' Puja, Feast |

All dates are tentative and subject to changes as per the lunar calendar. Please check the temple notice board or website for updates.
`,
  },

  'rath-yatra': {
    title: 'Rath Yatra 2026 – A Grand Celebration',
    content: `
The Rath Yatra is the most significant festival at Jagannath Mandir Rohini. It is celebrated with the same fervor as the Puri Rath Yatra.

## Event Details

**Date:** 24 June 2026 (Tentative)

## Schedule of Events

| Time | Activity |
|------|----------|
| Sunrise | Puja and preparation of the chariot |
| 10:00 AM | Rath Yatra procession starts from the temple |
| 10:00 AM – 12:00 PM | Procession through Rohini Sector 7 |
| 12:00 PM | Halt for rest and Mahaprasad distribution |
| 2:00 PM | Return procession |
| Evening | Arrival at temple, Sandhya Aarti, special prayers |

## How to Participate

- **Pull the Chariot** – Join the procession and pull the chariot
...
`,
  ...
  'events': {
    ...
    content: `
Jagannath Mandir Rohini hosts a vibrant calendar of events throughout the year. We celebrate all major Hindu festivals with great enthusiasm and devotion.

## Upcoming Events (2026)

- **Rath Yatra** – 24 June 2026
- **Jagannath Janma** – 17 July 2026
- **Krishna Janmashtami** – 25 August 2026
- **Ganesh Chaturthi** – 3 September 2026
- **Navratri Durga Puja** – 1-5 October 2026
- **Kali Puja / Deepavali** – 19 October 2026
- **Kartik Purnima** – 15 November 2026
- **Prathamastami** – 8 December 2026

## Weekly Events

- **Bhajan Sandhya** – Every Saturday 7:00 PM
- **Ram Katha** – First Sunday of every month
- **Spiritual Discourse** – Every Wednesday

## Community Participation

All events are open to the public. We encourage devotees to participate and experience the divine atmosphere.
`,
  },

  // ============================================
  // RITUALS, PRASAD, TIMINGS
  // ============================================

  'rituals': {
    title: 'Temple Rituals & Daily Seva',
    content: `
The Jagannath Mandir Rohini follows the ancient Vedic rituals as prescribed in the scriptures. The daily schedule includes multiple aartis, bhogs, and special ceremonies.

## Daily Rituals (Tentative Timings)

| Ritual | Timing |
|--------|--------|
| Mangala Aarti | 4:30 AM (Winter) / 4:00 AM (Summer) |
| Abhishek & Dhoop Aarti | 8:00 AM |
| Rajbhog Aarti | 12:00 PM |
| Sandhya Aarti | 6:30 PM (Winter) / 7:00 PM (Summer) |
| Shayana Aarti (Bedtime) | 9:30 PM |

## Weekly Specials

- **Monday** – Rudra Abhishek (Shiva)
- **Thursday** – Sai Baba Aarti
- **Saturday** – Hanuman Chalisa Path
- **Sunday** – Special Bhajan Sandhya

## Monthly Events

- **Ekadashi** – Fasting, special puja, and Jagran
...
`,
  ...
  'prasad-booking': {
    ...
    content: `
Mahaprasad is the divine offering to Lord Jagannath, and partaking it is considered highly auspicious. You can book prasad for various occasions.

## Types of Prasad Available

| Type | Description |
|------|-------------|
| Daily Bhog Prasadi | Sanctified meal offered daily, available after Aarti |
| Special Bhog | Sponsor specific bhog (Kheer, Sweets, or full meal) |
| Annadaan (Free Meal) | Sponsor free meal for the poor and underprivileged |
| Mahaprasad for Events | Bulk prasad for weddings, birthdays, or ceremonies |

## How to Book

- Visit the temple office and fill out a booking form.
- Book online via our donation page (select "Annaprasad" cause).
- Minimum 24 hours' notice required for bulk bookings.
...
`,
  ...
  'temple-timings': {
    ...
    content: `
Jagannath Mandir Rohini is open to devotees at the following timings.
...
| Rajbhog Aarti | 12:00 PM |
| Sandhya Aarti | 6:30 PM (Winter) / 7:00 PM (Summer) |
| Shayana Aarti | 9:30 PM |

## Special Darshan (Festival Days)

Temple remains open from early morning till late night during major festivals. Please check the event calendar for specific timings.

## Important Notes

- Temple is closed for cleaning between **12:30 PM – 4:00 PM** daily.
- On **Ekadashi**, the temple remains open till midnight.
- Prasad is available after the Rajbhog Aarti.

We welcome all devotees to visit and seek the blessings of Lord Jagannath.
`,
  },
